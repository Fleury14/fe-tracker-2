...
export default function v5ObjectiveDisplay({ objectives, req, onEdit, onComplete }: { objectives: Array<TObjective[]>, req: v5Requirement[], onEdit: (id: number) => void, onComplete: (id: number, group: number) => void }) {
